...
def digit(input_digit,input_action):
    ...
    global main_dict
    main_dict = {
    "app_type": response_single_ivr["response"]["app_type"],
    "play_menu": response_single_ivr["response"]["play_menu"],
    "name": response_single_ivr["response"]["name"],
    "voice": response_single_ivr["response"]["voice"],
    "play_welcome": response_single_ivr["response"]["play_welcome"],
    "get_extension": response_single_ivr["response"]["get_extension"],
    "menu": menu_dict
    }
    print(main_dict)
